...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post charts_url, params: { chart: { fable_id: @chart.fable_id, point: @chart.point, reference_date: @chart.reference_date, user_id: @chart.user_id } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { fable_id: @chart.fable_id, point: @chart.point, reference_date: @chart.reference_date, user_id: @chart.user_id } }
